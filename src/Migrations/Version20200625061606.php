 ...
 */
final class Version20200625061606 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE client ADD local_ip VARCHAR(25) NOT NULL, CHANGE ip_address ip_address VARCHAR(255) DEFAULT NULL, CHANGE api_key api_key VARCHAR(255) DEFAULT NULL, CHANGE api_secret api_secret VARCHAR(255) DEFAULT NULL, CHANGE product_version product_version VARCHAR(50) DEFAULT NULL, CHANGE local_network_alias_name local_network_alias_name VARCHAR(50) DEFAULT NULL');
