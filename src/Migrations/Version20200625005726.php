 ...
 */
final class Version20200625005726 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE firmware (id INT AUTO_INCREMENT NOT NULL, client_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', name VARCHAR(50) NOT NULL, content LONGTEXT NOT NULL, INDEX IDX_D5ECD7C419EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE firmware ADD CONSTRAINT FK_D5ECD7C419EB6921 FOREIGN KEY (client_id) REFERENCES client (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE firmware');
